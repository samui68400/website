...
export const client = createClient<Database>(
  ...
  process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ?? "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVsdWl6Ymd0Yml6cGVpbnlpcnp2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDE3NTI4MDIsImV4cCI6MjAxNzMyODgwMn0.bxG7jR4IaAiDitfsw8wkJj8dC56Ff2zR9h5WTsvPtcM"
);
